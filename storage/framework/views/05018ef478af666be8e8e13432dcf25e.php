    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-3 px-4">
                ...
                <p id="deleteMessage" class="text-muted mb-1">¿Desea eliminar este candidato?</p>
                <small class="text-muted">
                    <i class="ri-information-line me-1"></i>
                    Esta acción desactivará al candidato (los datos no se eliminan definitivamente).
                </small>
            </div>
...
<?php /**PATH D:\_Mine\sistema_electoral\resources\views\candidates\partials\modal-delete.blade.php ENDPATH**/ ?>