<div class="row g-4 mb-1">
    <div class="col-sm-auto">
        <div class="d-flex flex-wrap gap-2">
            ...
            <a href="<?php echo e(route('institutions.create')); ?>" class="btn btn-success">
            ...
            <div class="btn-group" role="group">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a class="dropdown-item" href="<?php echo e(route('institutions.export-all') . '?' . http_build_query(request()->except('selected_ids'))); ?>">
                            <i class="ri-file-excel-line me-1"></i> Exportar Todo
                            <small class="text-muted d-block">(<?php echo e($institutions->total()); ?> registros encontrados)</small>
                        </a>
                    </li>
                    <li>
    ...
    <div class="col-sm">
        <div class="filters-row">
            <form method="GET" action="<?php echo e(route('institutions.index')); ?>" id="filter-form">
                    ...
                    <div class="col-md-2">
                        <div class="action-buttons">
                            ...
                            <?php if(request()->hasAny(['search', 'department_id', 'status', 'operative'])): ?>
                                <a href="<?php echo e(route('institutions.index')); ?>" class="btn btn-outline-secondary btn">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <?php if(request('search')): ?>
                        <span class="badge bg-primary">
                            ...
                            <a href="<?php echo e(route('institutions.index', request()->except(['search', 'page']))); ?>" class="text-white ms-1">
                                <i class="ri-close-line"></i>
                            </a>
                        </span>
                    <?php endif; ?>
                    <?php if(request('department_id') && $departments->find(request('department_id'))): ?>
                        <span class="badge bg-info">
                            <?php echo e($departments->find(request('department_id'))->name); ?>

                            <a href="<?php echo e(route('institutions.index', request()->except(['department_id', 'page']))); ?>" class="text-white ms-1">
                                <i class="ri-close-line"></i>
                            </a>
                        </span>
                    <?php endif; ?>
                    <?php if(request('status') && isset($statusOptions[request('status')])): ?>
                        <span class="badge bg-success">
                            ...
                            <a href="<?php echo e(route('institutions.index', request()->except(['status', 'page']))); ?>" class="text-white ms-1">
                                <i class="ri-close-line"></i>
                            </a>
                        </span>
                    <?php endif; ?>
                    <?php if(request('operative') !== null): ?>
                        <span class="badge bg-warning text-dark">
                            Operativo: <?php echo e(request('operative') == 'true' ? 'Sí' : 'No'); ?>

                            <a href="<?php echo e(route('institutions.index', request()->except(['operative', 'page']))); ?>" class="text-dark ms-1">
                                <i class="ri-close-line"></i>
                            </a>
                        </span>
                    <?php endif; ?>
...
<form id="export-selected-form" action="<?php echo e(route('institutions.export-selected')); ?>" method="POST" style="display: none;">
    <?php echo csrf_field(); ?>
...
<?php /**PATH D:\_Mine\sistema_electoral\resources\views\institutions\partials\actions-bar.blade.php ENDPATH**/ ?>