<div class="app-menu navbar-menu">
    <nav class="navbar-brand-box">
        <!-- Dark Logo-->
        <a href="<?php echo e(route('root')); ?>" class="logo logo-dark">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('build/images/logo_elections.png')); ?>" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('build/images/logo_elections_large.png')); ?>" alt="" height="50">
            </span>
        </a>
        <!-- Light Logo-->
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown <?php echo e(request()->routeIs('users.*') ? 'show' : ''); ?>"
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_delegates')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('users.delegates')); ?>" class="nav-link <?php echo e(request()->routeIs('users.delegates') ? 'active' : ''); ?>">
                                    <i class="ri-shield-user-line nav-icon"></i>
                                    <span class="nav-name">Delegados</span>
                                    <?php if($delegatesCount ?? 0 > 0): ?>
                                        <span class="badge bg-success ms-auto"><?php echo e($delegatesCount); ?></span>
                                    <?php endif; ?>
                                </a>
                            </li>
                            <?php endif; ?>
