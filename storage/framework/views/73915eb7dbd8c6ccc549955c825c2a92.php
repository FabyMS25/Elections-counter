        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                <div class="btn-group btn-group-sm">
                    <a href="?seat_mode=validated<?php echo e(request()->has('department') ? '&' . http_build_query(request()->except('seat_mode')) : ''); ?>"
                       class="btn <?php echo e(($currentSeatMode ?? 'all') == 'validated' ? 'btn-primary' : 'btn-outline-primary'); ?>">
                        <i class="ri-checkbox-circle-line me-1"></i>📋 Oficial
                    </a>
                    <a href="?seat_mode=all<?php echo e(request()->has('department') ? '&' . http_build_query(request()->except('seat_mode')) : ''); ?>"
                       class="btn <?php echo e(($currentSeatMode ?? 'all') == 'all' ? 'btn-primary' : 'btn-outline-primary'); ?>">
        ...
        <?php else: ?>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $sortedAnalysis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partyName => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $rank = $loop->iteration;
                            ...
                            <tr>
                                <td class="text-center">
                                    <span class="badge rounded-pill" style="background:<?php echo e($barColor); ?>; color:white;">
                                        <?php echo e($rank); ?>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <?php if($partyLogo): ?>
                                            <img src="<?php echo e(asset('storage/'.$partyLogo)); ?>"
                                                 class="rounded-circle"
                                                 style="width:25px;height:25px;object-fit:cover;">
                                        <?php else: ?>
                                            <div class="rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                                                 style="width:25px;height:25px;background:<?php echo e($barColor); ?>;">
                                                <?php echo e(strtoupper(substr($partyName, 0, 1))); ?>

                                            </div>
                                        <?php endif; ?>
                                        <div>
                                            <span class="fw-semibold"><?php echo e($partyName); ?></span>
                                            <?php if($isTop3): ?>
                                                <i class="ri-medal-<?php echo e($rank == 1 ? 'gold' : ($rank == 2 ? 'silver' : 'bronze')); ?>-line ms-1"></i>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center fw-bold"><?php echo e(number_format($data['votes'])); ?></td>
                                <td class="text-center">
                                    <span class="badge bg-primary rounded-pill fs-6 px-3"><?php echo e($data['seats']); ?></span>
                                </td>
                                <td class="text-center">
                                    <?php if($data['votes_needed_for_next_seat'] > 0): ?>
                                        <?php echo e(number_format($data['votes_needed_for_next_seat'])); ?>
                                ...
                                <td class="text-center">
                                    <span class="badge bg-<?php echo e($statusClass); ?><?php echo e($statusClass == 'warning' ? ' text-dark' : ''); ?>">
                                        <i class="<?php echo e($statusIcon); ?> me-1"></i><?php echo e($statusText); ?>
                                ...
                                <td>
                                    <div class="d-flex flex-column gap-1">
                                        <div class="progress" style="height:6px;">
                                            <div class="progress-bar" style="width: <?php echo e($percentage); ?>%; background: <?php echo e($barColor); ?>;"></div>
                                        </div>
                                        <small class="text-muted text-center"><?php echo e($percentage); ?>%</small>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="col-md-4">
                    <div class="card bg-primary-subtle border-0">
                        <div class="card-body py-1">
                            ...
                            <h4 class="mb-0"><?php echo e(number_format($totalValidVotes)); ?></h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card bg-success-subtle border-0">
                        <div class="card-body py-1">
                            ...
                            <h4 class="mb-0"><?php echo e(array_sum($currentSeats['seats'])); ?></h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card bg-warning-subtle border-0">
                        <div class="card-body py-1">
                            ...
                            <h4 class="mb-0"><?php echo e(number_format($currentSeats['cutoff'], 2)); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
...
</div><?php /**PATH D:\_Mine\sistema_electoral\resources\views\partials\dashboard-seats.blade.php ENDPATH**/ ?>