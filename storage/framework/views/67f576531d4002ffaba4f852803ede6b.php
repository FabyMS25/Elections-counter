                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if(isset($categoryStats[$activeCategoryCode])): ?>
                            <?php
                            ...
                            <tr class="table-light fw-semibold">
                                ...
                                <td>
                                    <span class="badge bg-secondary-subtle text-secondary border">
                                        <i class="ri-subtract-line me-1"></i>Blancos: <?php echo e(number_format($blankForCat)); ?>

                                    </span>
                                </td>
                                <td>
                                    <span class="badge bg-danger-subtle text-danger border">
                                        <i class="ri-close-line me-1"></i>Nulos: <?php echo e(number_format($nullForCat)); ?>

                                    </span>
                                </td>
                                <td>
                                    <?php if($totalForCat > 0): ?>
                                        <small class="text-muted">
                                            <?php echo e(round((($blankForCat + $nullForCat) / $totalForCat) * 100, 1)); ?>% del total
                                        </small>
                                    <?php endif; ?>
                                </td>
                            </tr>
