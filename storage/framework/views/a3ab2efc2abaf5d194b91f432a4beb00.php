...
<?php $__env->startSection('css'); ?>
    ...
    <link href="<?php echo e(URL::asset('build/libs/choices.js/choices.js.min.css')); ?>" rel="stylesheet" type="text/css" />
    <style>
...
unset($__errorArgs, $__bag); ?>" name="institution_id" id="institution-field" required>
                                ...
                                <?php $__currentLoopData = $institutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($institution->id); ?>" <?php echo e(old('institution_id') == $institution->id ? 'selected' : ''); ?>>
                                        <?php echo e($institution->name); ?> - <?php echo e($institution->municipality->name); ?>, <?php echo e($institution->municipality->department->name); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/libs/choices.js/choices.js.min.js')); ?>"></script>
