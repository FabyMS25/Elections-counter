...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                                ...
                                <input type="text" id="party_full_name-field" name="party_full_name" class="form-control"
                                    placeholder="Nombre completo del partido" value="<?php echo e(old('party_full_name')); ?>" maxlength="255" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                                ...
                                <input type="text" id="list_name-field" name="list_name" class="form-control"
                                    placeholder="Ej: Lista 1, Frente Amplio" value="<?php echo e(old('list_name')); ?>" maxlength="255" />
                                <?php $__errorArgs = ['list_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                                ...
                                <?php $__errorArgs = ['election_type_category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
<?php /**PATH D:\_Mine\sistema_electoral\resources\views\candidates\partials\modal-form.blade.php ENDPATH**/ ?>