            ...
            <div class="col-lg-7">
                <div class="d-flex align-items-center gap-3 mb-2">
                    ...
                    <span class="ms-auto fw-bold text-success" style="font-size:1.1rem;"
                          id="ds-stat-pct"><?php echo e($progressPercentage); ?></span>
                ...
                <div class="progress" style="height:8px;border-radius:8px;background:#e9ecef;">
                    <div class="progress-bar bg-success progress-bar-striped progress-bar-animated"
                         id="ds-big-bar"
                         role="progressbar"
                         style="width:<?php echo e($progressPercentage); ?>%;border-radius:8px;transition:width .6s ease;">
                    </div>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="row g-0 text-center">
                    <div class="col-4 border-end">
                        <div class="fw-bold fs-5 text-success lh-1 reported-tables-count" id="ds-stat-reported">
                            <?php echo e(number_format($reportedTables)); ?>
                    ...
                    <div class="col-4 border-end">
                        <div class="fw-bold fs-5 text-warning lh-1 pending-tables-count" id="ds-stat-pending">
                            <?php echo e(number_format($totalTables - $reportedTables)); ?>
                    ...
                    <div class="col-4">
                        <div class="fw-bold fs-5 text-secondary lh-1 total-tables-count" id="ds-stat-total">
                            <?php echo e(number_format($totalTables)); ?>
...
</div><?php /**PATH D:\_Mine\sistema_electoral\resources\views\partials\dashboard-tables-stats.blade.php ENDPATH**/ ?>