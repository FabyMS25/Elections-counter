<?php $__env->startSection('title'); ?> Gestión de Candidatos <?php $__env->stopSection(); ?>
...
<?php $__env->startComponent('components.breadcrumb'); ?>
    ...
    <?php $__env->slot('title'); ?> Gestión de Candidatos <?php $__env->endSlot(); ?>
    ...
    <div class="row g-3 mb-2">
        <div class="col-6 col-md-3">
            <div class="stat-card">
                ...
                <div><div class="num"><?php echo e($candidates->total()); ?></div><div class="lbl">Total candidatos</div></div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="stat-card">
                <div class="icon bg-success bg-opacity-10 text-success"><i class="ri-stack-line"></i></div>
                <div><div class="num"><?php echo e($stats['byCategory']->count()); ?></div><div class="lbl">Categorías activas</div></div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="stat-card">
                <div class="icon bg-info bg-opacity-10 text-info"><i class="ri-map-pin-line"></i></div>
                <div><div class="num"><?php echo e($stats['byDepartment']->count()); ?></div><div class="lbl">Departamentos</div></div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="stat-card">
                <div class="icon bg-warning bg-opacity-10 text-warning"><i class="ri-government-line"></i></div>
                <div><div class="num"><?php echo e($stats['byElectionType']->count()); ?></div><div class="lbl">Tipos de elección</div></div>
            </div>
        </div>
    </div>
    <div class="mb-2">
...
<div class="card mb-2">
    <div class="card-body py-2 px-2">
        <form method="GET" action="<?php echo e(route('candidates.index')); ?>" id="filterForm">
            <div class="row g-2 align-items-end">
                <div class="col-md-4">
                    ...
                    <div class="input-group input-group">
                        ...
                        <input type="text" name="search" class="form-control border-start-0 ps-0"
                               placeholder="Nombre, partido, lista…" value="<?php echo e(request('search')); ?>">
                    </div>
                </div>
                <div class="col-md-2">
                    ...
                    <select name="election_type_id" class="form-select form-select">
                        ...
                        <?php $__currentLoopData = $electionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $et): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($et->id); ?>" <?php echo e(request('election_type_id') == $et->id ? 'selected' : ''); ?>>
                                <?php echo e($et->name); ?>
                ...
                <div class="col-md-2">
                    ...
                    <select name="election_type_category_id" class="form-select form-select">
                        ...
                        <?php $__currentLoopData = $etcs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($etc->id); ?>" <?php echo e(request('election_type_category_id') == $etc->id ? 'selected' : ''); ?>>
                                <?php echo e($etc->electionCategory->code); ?> — <?php echo e($etc->electionCategory->name); ?>
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <?php if(request()->hasAny(['search','election_type_id','election_type_category_id','department_id'])): ?>
                    <a href="<?php echo e(route('candidates.index')); ?>" class="btn btn-outline-secondary btn" title="Limpiar">
            ...
            <div class="mt-2 d-flex align-items-center gap-2 flex-wrap">
                ...
                <span class="badge bg-primary d-inline-flex align-items-center gap-1" style="font-size:.75rem">
                    ...
                    <a href="<?php echo e(route('candidates.index', request()->except(['search','page']))); ?>" class="text-white ms-1"><i class="ri-close-line"></i></a>
                </span>
                <?php endif; ?>
                <?php if(request('election_type_id') && ($selEt = $electionTypes->find(request('election_type_id')))): ?>
                <span class="badge bg-warning text-dark d-inline-flex align-items-center gap-1" style="font-size:.75rem">
                    <i class="ri-government-line"></i> <?php echo e($selEt->name); ?>

                    <a href="<?php echo e(route('candidates.index', request()->except(['election_type_id','page']))); ?>" class="text-dark ms-1"><i class="ri-close-line"></i></a>
                </span>
                <?php endif; ?>
                <?php if(request('election_type_category_id') && ($selCat = $etcs->find(request('election_type_category_id')))): ?>
                <span class="badge bg-info d-inline-flex align-items-center gap-1" style="font-size:.75rem">
                    <i class="ri-stack-line"></i> <?php echo e($selCat->electionCategory->code); ?>

                    <a href="<?php echo e(route('candidates.index', request()->except(['election_type_category_id','page']))); ?>" class="text-white ms-1"><i class="ri-close-line"></i></a>
                </span>
                <?php endif; ?>
                ...
                <span class="badge bg-success d-inline-flex align-items-center gap-1" style="font-size:.75rem">
                    ...
                    <a href="<?php echo e(route('candidates.index', request()->except(['department_id','page']))); ?>" class="text-white ms-1"><i class="ri-close-line"></i></a>
                </span>
                <?php endif; ?>
            </div>
            <?php endif; ?>
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between py-2 px-3">
        <h5 class="card-title mb-0">
            Candidatos <span class="badge bg-secondary ms-1"><?php echo e($candidates->total()); ?></span>
        </h5>
        <div class="d-flex gap-2">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="<?php echo e(route('candidates.export-all') . '?' . http_build_query(request()->except('selected_ids','page'))); ?>">
                        <i class="ri-file-excel-line me-2 text-success"></i>Exportar todo (<?php echo e($candidates->total()); ?>)
                    </a></li>
                    ...
                    <li><a class="dropdown-item" href="<?php echo e(route('candidates.template')); ?>">
    ...
    <div class="card-footer d-flex align-items-center justify-content-between flex-wrap gap-2 py-2 px-3">
        <div class="d-flex align-items-center gap-2">
            <small class="text-muted">Mostrando <?php echo e($candidates->firstItem()); ?>–<?php echo e($candidates->lastItem()); ?> de <?php echo e($candidates->total()); ?> candidatos</small>
...
<form id="export-selected-form" action="<?php echo e(route('candidates.export-selected')); ?>" method="POST" style="display:none"><?php echo csrf_field(); ?></form>
<?php $__env->stopSection(); ?>
