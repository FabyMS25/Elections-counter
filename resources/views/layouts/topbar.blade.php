                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge bg-light-subtle text-body fs-13"> {{ $totalNotifications ?? 0 }} Nuevas</span>
                                    </div>
                                </div>
                        ...
                        <div class="tab-content" id="notificationItemsTabContent">
                                ...
                                <div class="text-reset notification-item d-block dropdown-item">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-13 fw-semibold">Mesa {{ $obs->votingTable->number }}</h6>
                                            <p class="mb-1 fs-12 text-muted"><b>{{ $obs->votingTable->institution->name }}</b>: {{ $obs->description }}</p>
                                            <p class="mb-0 fs-11 text-muted"><span><i class="mdi mdi-clock-outline"></i> {{ $obs->created_at->diffForHumans() }}</span></p>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                            ...
                            <div class="tab-pane fade py-2 ps-2" id="actas-tab" role="tabpanel">
                                ...
                                <div class="text-reset notification-item d-block dropdown-item">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-13 fw-semibold">Acta Mesa {{ $acta->votingTable->number }}</h6>
                                            <p class="mb-1 fs-12 text-muted">Subida en: {{ $acta->votingTable->institution->name }}</p>
                                            <p class="mb-0 fs-11 text-muted"><span><i class="mdi mdi-clock-outline"></i> {{ $acta->created_at->diffForHumans() }}</span></p>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                            ...
                            <div class="tab-pane fade py-2 ps-2" id="progress-tab" role="tabpanel">
                                @foreach($validatedByRecinto as $group)
                                <div class="text-reset notification-item d-block dropdown-item">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-xs me-3 flex-shrink-0">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="m-0 fs-13 fw-semibold">{{ $group->validated_count }} mesas validadas</h6>
                                            <span class="text-muted fs-11">{{ $group->institution->name }}</span>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
