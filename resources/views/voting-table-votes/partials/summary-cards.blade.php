            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h3 class="mb-0 text-white">{{ number_format($tableStats['total'] ?? 0) }}</h3>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h3 class="mb-0 text-white">{{ number_format($totals['expected'] ?? 0) }}</h3>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h3 class="mb-0 text-white">{{ number_format($totals['total'] ?? 0) }}</h3>
                ...
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h3 class="mb-0 text-white">
                            {{ isset($totals['expected']) && $totals['expected'] > 0 ? round(($totals['total'] / $totals['expected']) * 100, 1) : 0 }}%
                        </h3>
        ...
        <div class="card border-primary">
            ...
            <div class="card-body py-3">
                <div class="row text-center">
                    <div class="col-6">
                        <h4 class="text-primary mb-0">{{ number_format($totals['alcalde'] ?? 0) }}</h4>
                        <small class="text-muted">Votos Válidos</small>
                    </div>
                    <div class="col-6">
                        <h4 class="text-primary mb-0">{{ isset($totals['alcalde']) && $totals['total'] > 0 ? round(($totals['alcalde'] / $totals['total']) * 100, 1) : 0 }}%</h4>
    ...
    <div class="col-md-6">
        <div class="card border-success">
            ...
            <div class="card-body py-3">
                <div class="row text-center">
                    <div class="col-6">
                        <h4 class="text-success mb-0">{{ number_format($totals['concejal'] ?? 0) }}</h4>
                        <small class="text-muted">Votos Válidos</small>
                    </div>
                    <div class="col-6">
                        <h4 class="text-success mb-0">{{ isset($totals['concejal']) && $totals['total'] > 0 ? round(($totals['concejal'] / $totals['total']) * 100, 1) : 0 }}%</h4>
                        <small class="text-muted">del total</small>
                    </div>
                </div>
            </div>
...
@if(isset($candidates) && $candidates->isNotEmpty() && isset($totals['by_candidate']) && count(array_filter($totals['by_candidate'])) > 0)
<div class="row mb-4">
    <div class="col-12">
        <div class="card">
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="text-end">
                                            ...
                                            <small class="text-{{ $categoryClass }}">{{ $percentage }}%</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
