...
@section('dashboard-scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {            
            const candidateNames = @json($candidates->pluck('name'));
            const candidateColors = @json($candidates->pluck('color'));
            const candidateVotes = @json($candidates->map(function($candidate) use ($candidateStats) {
